%macro ds_set() / parmbuff store source;
/*-----------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------*/
/* MACRO DESCRIPTION:                                                          */
/*    Acts as a regular DATA step SET statements excepts creates ATTRIB        */
...
/*-----------------------------------------------------------------------------*/
/* USAGE DOCUMENTATION:                                                        */
/*  - Use %DS_SET in the DATA step as you would the SET statement.             */
/*                                                                             */
/*  - Supply a comma separated list of each of the datasets that you would     */
/*    put on a SET statement                                                   */
/*                                                                             */
...
/*                                                                             */
/*    data CONCAT_TABLES;                                                      */
/*       %DS_SET(npmext.table1(drop=var1 rename=(varA=var2))                   */
...
/*    BEFORE the %DS_SET, then (similar to when using a MERGE statement), that */
/*    first assignment initializes the variable, not %DS_SET                   */
/*                                                                             */
/*-----------------------------------------------------------------------------*/
